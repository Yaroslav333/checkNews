...
@section('content')
    <div style="margin-top: 30px; margin-left: 20px;">
        <a href="/admin/greetings/create" class="waves-effect waves-light btn" style="background-color: #ff8905">Добавить Сообщение</a>
    </div>
            ...
            @if(!empty($news))
                @foreach($news as $item)
                    ...
                    <div class="col s6 m4 news_box_index" data-loc="{{'/admin/news/' . $item->id}}" onclick="window.location = $(this).data('loc');">
                        <div class="col s12 m11 card news_box_index" style="overflow-y:auto; height:400px; position: relative">
