        ...
        <div class="row">
            ...
            <div class="col l12 game_news_card">
                <div class="col s2 m2 l2" style="margin-top:220px; text-align: center;">
                    <a class="btn-floating btn-large waves-effect waves-light red" id="fake_icon" style="display: none"><i class="material-icons news_icon" style="font-size: 16pt;margin-top: 5px;">Брехня</i></a>
                </div>
                ...
                <div class="col s2 m2 l2" style="margin-top:220px;text-align: center;padding-left: 0px;">
                    <a class="btn-floating btn-large waves-effect waves-light green" id="true_icon" style="display: none"><i class="material-icons news_icon" style="font-size: 16pt;margin-top: 5px;">Правда</i></a>
                </div>
            </div>
